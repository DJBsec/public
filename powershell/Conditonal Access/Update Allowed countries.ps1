...
###### The below powershell script is run to update a specific policy in AzureAD Conditional Access                  ######
...
#########################Policies#########################
# Current Policies to Update or Test  xxxxxxxx-xxxx-xxxx-xxxx-xxxxxxxxxxxx = Policy ID
...
############### Create an allow countries policy that this script updates               ###############
